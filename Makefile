...
OBJ := player team tui tuiswap tuidb tuiskills combo args sql dlist log utils render skill listarea tuicombo config position generate tuipositions playeredit
